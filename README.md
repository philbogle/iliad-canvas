...
The primary Greek text is based on the OCT. The literary translation used is the modern blank verse translation by **Ian Johnston** (2006, Vancouver Island University), which he released into the public domain and has been adapted here to map to the Greek hexameter lines. Literal glosses were compiled to assist with word-for-word morphology.
