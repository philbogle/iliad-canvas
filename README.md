...
- **Performance Audio Options**: An interactive player that allows you to switch between three vocal performances: the Perkʷunós' archaic sung recitation (default), Luke Ranieri's (polýMATHY) restored 3-pitch chanting, and David Chamberlain's clear metrical reading (Erasmian).
